      ...
      <div className="footer">
        <div className="Border">
          ...
          <div className="contact">
            <div>
              <FaPhone />
              <a className='phone' href="tel:+919116457772">Aman Tripathi:- +91 8115610105</a>

            </div>
            <div>
              <FaPhone />
              <a className='phone' href="tel:+919506424755">Harsh Sharma:- +91 8383936346</a>
            </div>
            <div>
              <MdEmail />

              <a href="mailto:mittalyas1234@gmail.com" className='phone' >Email - mittalyas1234@gmail.com</a>
          ...
          <div className="find-us">
            ...
            <div className="social-icons">
              <a href="https://www.linkedin.com/company/jiitopticachapter/" className="link">
                <FaLinkedin />
              </a>
              <a href="https://www.facebook.com/jiitopticachapter/" className="link">
                <FaSquareFacebook />
              </a>
              <a href="https://github.com/jiitopticachapter" className="link">
                <FaGithubSquare />
              </a>
              <a href="https://www.instagram.com/jiitopticachapter/" className="link">
                <FaInstagramSquare />
              </a>
              <a href="https://www.youtube.com/@jiitopticachapter7634" className="link">
                <FaYoutubeSquare />
              </a>
            </div>
          </div>
